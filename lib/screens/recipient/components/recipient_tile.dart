      ...
      child: InkWell(
        onLongPress: () {
          ...
          if (isSelect) {
            ...
            context.read<SelectedRecipientBloc>().add(
                CallUnselectRecipientItem(selectedRecipient: widget.recipient));
          }
        },
        onTap: () => isSelect
            ? null
                    ...
                    builder: (_) => MessageScreen(
                          recipients: [
                            RecipientModel(
                                ...
                                number: widget.recipient.number)
                          ],
                        ))),
        child: Card(
          ...
          color: isSelect
              ...
              : Colors.transparent,
          surfaceTintColor:
              isSelect ? Colors.deepPurpleAccent : Colors.transparent,
          child: Padding(
